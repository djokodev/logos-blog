...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.global_context', # Custom processor for menu
            ],
        },
    },
]
...
# Database configuration (using PostgreSQL by default if env is set, otherwise SQLite for simple local dev)
...
# Media files (uploaded covers, resources, etc.)
MEDIA_URL = '/media/'
